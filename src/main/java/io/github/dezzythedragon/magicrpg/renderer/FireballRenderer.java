...
public class FireballRenderer extends EntityRenderer<MagicFireballProjectile> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(MagicRPG.MODID, "textures/entity/spells/fireball_projectile.png");
    ...
    @Override
    public void render(MagicFireballProjectile pEntity, float pEntityYaw, float pPartialTick,
    ...
    @Override
    public ResourceLocation getTextureLocation(MagicFireballProjectile pEntity) {
